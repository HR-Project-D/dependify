          ...
          >
            ...
            <Dialog.Content asChild forceMount className="fixed z-[60]">
              <motion.div
                ...
                transition={{ duration: 0.3, ease: "easeInOut" }}
                className={`no-scrollbar fixed left-[25%] top-[10%] z-[60] flex max-h-[80%] flex-col gap-8 overflow-y-scroll rounded-lg border border-white-8 bg-gray-0 p-8 pt-0 drop-shadow-2xl ${
